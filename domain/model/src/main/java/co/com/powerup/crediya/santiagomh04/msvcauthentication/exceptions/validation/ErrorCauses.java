...
public enum ErrorCauses {
    ...
    INVALID_TELEPHONE_FORMAT_ERROR("your telephone number must have al least 10 digits"),
    UNDERAGE_ERROR("you must be at least 18 years old to get an account"),
    SALARY_OUT_OF_RANGE_ERROR("your salary must be within the range 0 - 15 millions");
